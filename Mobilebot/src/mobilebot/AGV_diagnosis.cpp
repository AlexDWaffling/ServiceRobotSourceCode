...
#include "../../include/mobilebot/AGV_diagnosis.h"

AGVDiagnosis::AGVDiagnosis()
{
}
...
bool AGVDiagnosis::init(void)
{
  //DEBUG_SERIAL.println("Success to init Diagnosis");
  return true;
}

void AGVDiagnosis::showLedStatus(bool isConnected)
{
...
void AGVDiagnosis::updateRxTxLed(void)
{
...
void AGVDiagnosis::setPowerOn(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, HIGH);
}

void AGVDiagnosis::setPowerOff(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, LOW);
}

uint8_t AGVDiagnosis::updateVoltageCheck(bool check_setup)
{  
...
uint8_t AGVDiagnosis::getButtonPress(uint16_t time_to_press)
{
