...
void updateGoalVelocity(void)
{
  ...
  //goal_velocity[LINEAR] = 0.1;
 //goal_velocity[ANGULAR] =  0.1;
}
...
void sendLogMsg(void)
{
  ...
  String name = "Indruino";
  String firmware_version = "1.0";
  String bringup_log = "This core(v" + firmware_version + ") is compatible with MBT1 " + name;
  ...
  if (nh.connected())
  {
    if (log_flag == false)
    {
      ...
      sprintf(log_msg, "Connected to AGV board!");
      nh.loginfo(log_msg);
